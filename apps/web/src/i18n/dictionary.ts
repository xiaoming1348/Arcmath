 ...
 * English natural; keep Chinese formal (not colloquial) since the
...
export type Messages = {
  ...
  "for_schools.core_eyebrow": string;
  "for_schools.core_title": string;
  "for_schools.core_lede": string;
  ...
  "for_schools.contact_eyebrow": string;
  ...
  "org.overview.action.resource.assignment.draft": string;
  "org.overview.action.resource.assignment.extract": string;
  "org.overview.action.class.invite_students": string;
  "org.overview.action.teacher.invite": string;
  "org.overview.action.teacher.prep.generate": string;
  ...
  "home.platform.eyebrow": string;
  "home.platform.title": string;
  "home.platform.lede": string;
  "home.platform.admin_title": string;
  "home.platform.admin_meta": string;
  "home.platform.admin_body": string;
  "home.platform.material_title": string;
  "home.platform.material_meta": string;
  "home.platform.material_body": string;
  "home.platform.student_title": string;
  "home.platform.student_meta": string;
  "home.platform.student_body": string;
  "home.platform.gradebook_title": string;
...
export const EN: Messages = {
  ...
  "topnav.tagline": "Math teaching platform",
  ...
  "for_schools.eyebrow": "For schools and tutoring organizations",
  "for_schools.hero_title": "A teaching assistance platform for serious math classes.",
  "for_schools.hero_lede": "Arcmath brings class management, PDF materials, assignments, student submissions, verified grading, and teacher-facing insight into one workflow for international schools and tutorial organizations.",
  "for_schools.cta_email": "Contact us",
  "for_schools.cta_register_school": "Create a school account",
  "for_schools.why_eyebrow": "Why this matters",
  "for_schools.why_title": "Math teaching needs more than a problem bank.",
  "for_schools.why_body_1": "Schools need a single place to organize classes, assign the right material, collect work before the deadline, and see how students are actually reasoning through problems.",
  "for_schools.why_body_2": "Arcmath is designed around that daily workflow: administrators manage the organization, teachers prepare and grade assignments, and students receive structured feedback without the system simply handing them the answer.",
  "for_schools.why_callout_label": "Product focus",
  "for_schools.why_callout_body": "The platform supports internal teaching operations first: rosters, classes, PDF materials, scoped assignments, submissions, grading, reports, and teacher preparation.",
  "for_schools.pillars_eyebrow": "What Arcmath is",
  "for_schools.pillars_title": "Three product layers that work together.",
  "for_schools.pillar_1_title": "Organization control",
  "for_schools.pillar_1_body": "Each organization has an admin account that manages classes, assigns teachers and students, and reviews activity across accounts inside that organization.",
  "for_schools.pillar_2_title": "Material-based assignments",
  "for_schools.pillar_2_body": "Teachers can upload PDF materials, select pages or problem ranges, combine them with Arcmath resources, set due times, and collect student submissions in one place.",
  "for_schools.pillar_3_title": "Verified grading and insight",
  "for_schools.pillar_3_body": "Student answers can be reviewed with formal-verification-aware grading, teacher overrides, class gradebooks, and reports that make weak points visible without losing the original work.",
  "for_schools.core_eyebrow": "Core functions",
  "for_schools.core_title": "The product should show what teachers and students actually do.",
  "for_schools.core_lede": "These live motion panels demonstrate the work loop: capture math, check reasoning, give teacher-safe hints, and turn submissions into class-level insight.",
  "for_schools.flow_eyebrow": "School workflow",
  "for_schools.flow_title": "From class setup to graded submission.",
  "for_schools.flow_1_title": "Set up the organization.",
  "for_schools.flow_1_body": "The org admin creates classes, invites or creates teacher accounts, and places student accounts into the correct classes.",
  "for_schools.flow_2_title": "Prepare an assignment.",
  "for_schools.flow_2_body": "The teacher uploads a PDF or uses existing resources, selects the exact pages and problem range, transforms the selected problems into assignment items, and sets the due time.",
  "for_schools.flow_3_title": "Students submit work.",
  "for_schools.flow_3_body": "Students open the assigned material, write or upload their answers, and submit before the deadline. Late and missing submissions remain visible to the teacher.",
  "for_schools.flow_4_title": "Teachers grade and review.",
  "for_schools.flow_4_body": "Teachers grade submissions with the help of verified grading signals, then inspect class-level results and individual student history.",
  "for_schools.contact_eyebrow": "Next step",
  "for_schools.cta_panel_title": "Discuss school setup",
  ...
  "legal.terms_body_who": "Arcmath is a math teaching and practice platform. Anyone aged 13 or older may register an individual account. Students under 13 must be onboarded through their school under an institutional agreement, and a parent or legal guardian must consent before the student begins practice.",
  ...
  "legal.terms_body_disclaimer": "Arcmath is provided \"as is\" during the current pre-production phase. We don't guarantee specific grade outcomes, contest scores, or admissions results. To the extent legally allowed, Arcmath is not liable for indirect or consequential damages arising from use of the platform.",
  "legal.terms_h_changes": "Changes",
  "legal.terms_body_changes": "If we materially change these terms, we'll notify registered users by email at least 14 days before the change takes effect.",
  ...
  "register.subtitle": "Create a personal Arcmath account to use the problem library, step-by-step grading, and progress reports.",
  ...
  "org.overview.action.resource.assignment.draft": "{actor} formatted a PDF assignment draft",
  "org.overview.action.resource.assignment.extract": "{actor} extracted selected PDF pages",
  ...
  "org.overview.action.teacher.prep.generate": "{actor} generated a teacher prep brief",
  ...
  "home.hero.kicker": "For schools, tutoring centers, and math departments",
  "home.hero.headline": "math platform for verified classwork.",
  "home.hero.subhead": "Run classes, assign PDFs or library work, collect submissions, and grade with formal verification where it applies.",
  "home.hero.pill_practice": "Org rosters and class control",
  "home.hero.pill_progress": "PDF-to-assignment workflow",
  "home.hero.pill_aesthetic": "Verified grading · reports · prep assistant",
  ...
  "home.hero.cta_student": "Individual practice",
  "home.hero.cta_school": "Create school account",
  "home.hero.student_label": "Individual learners",
  "home.hero.student_tagline": "Practice from the ArcMath library with step feedback, hints, OCR, and personal reports.",
  "home.hero.school_label": "Schools and tutoring orgs",
  "home.hero.school_tagline": "One admin account controls the org, creates classes, assigns teachers and students, and can inspect account activity across the tenant.",
  "home.hero.signin_prompt": "Already have an account?",
  "home.hero.signin_link": "Sign in",
  "home.stats.practice_label": "Org control",
  "home.stats.practice_value": "1 admin",
  "home.stats.practice_desc": "Each organization has one owning admin who creates classes, assigns teacher and student accounts, resets passwords, and reviews activity inside the org.",
  "home.stats.verification_label": "Assignments",
  "home.stats.verification_value": "PDF + library",
  "home.stats.verification_desc": "Teachers can use ArcMath resources or select pages and problem ranges from their own PDF materials, then publish work with due times.",
  "home.stats.library_label": "Grading",
  "home.stats.library_value": "Verified",
  "home.stats.library_desc": "Structured problems use symbolic and formal-verification backends where available; PDF work stays teacher-reviewed with clear grading records.",
  "home.platform.eyebrow": "School workflow",
  "home.platform.title": "The core classroom loop is now built around roles.",
  "home.platform.lede": "ArcMath is not just a contest catalog. It is the operating layer for math classes, homework, resource delivery, submissions, grading, and progress visibility.",
  "home.platform.admin_title": "Admin owns the org",
  "home.platform.admin_meta": "Create classes · assign accounts",
  "home.platform.admin_body": "A school or tutoring org gets one admin account. The admin creates classes, adds teachers and students, controls membership, and can inspect any account under that org.",
  "home.platform.material_title": "Teachers assign from materials",
  "home.platform.material_meta": "PDF pages · problem ranges · library sets",
  "home.platform.material_body": "Teachers upload PDFs, select pages and problem numbers from long books, transform the source into student-ready prompts, or assign existing ArcMath problem sets.",
  "home.platform.student_title": "Students submit before due time",
  "home.platform.student_meta": "Structured answers · file submissions",
  "home.platform.student_body": "Students see their class assignments, work in the math workspace when the problem is structured, or attach written work for PDF/manual homework.",
  "home.platform.gradebook_title": "Teachers grade and review",
  ...
  "home.demo.ocr_eyebrow": "01 / Student input",
  "home.demo.ocr_title": "Snap written math, convert to LaTeX, then submit.",
  "home.demo.grading_eyebrow": "02 / Verified grading",
  "home.demo.grading_title": "See exactly which engine signed the step.",
  "home.demo.hint_eyebrow": "03 / Teacher-safe help",
  "home.demo.hint_title": "Concise nudges and prep support, not answer dumping.",
  "home.demo.report_eyebrow": "04 / Class insight",
  "home.demo.report_title": "Progress data teachers can act on.",
  "home.hero.florid_word": "school",
  "home.cards.sympy_title": "01 / SymPy",
  "home.cards.sympy_body": "Algebraic identities, equation manipulation, simple inequalities. For supported structured steps, SymPy returns a deterministic verdict without an LLM round-trip.",
  "home.cards.lean_title": "02 / Lean kernel",
  "home.cards.lean_body": "Proof-level claims can run through Lean and mathlib. When a claim type-checks, the verdict comes from the kernel rather than natural-language confidence.",
  "home.cards.llm_title": "03 / LLM judge",
  "home.cards.llm_body": "For arguments outside the formalized surface, an LLM judge can summarize or flag reasoning, with the result clearly tagged instead of mixed into a black-box score.",
  "home.helps.kicker": "Built for math teams",
  "home.helps.headline": "Canvas-style class operations, with math-specific intelligence.",
  "home.helps.subhead": "The platform handles the internal workflow schools actually need: rosters, materials, deadlines, submissions, grading, reports, and teacher preparation.",
  "home.helps.assignments_title": "Class and roster control",
  "home.helps.assignments_body": "Admins create classes, assign teacher and student accounts, and keep one controlled view of the whole organization.",
  "home.helps.resources_title": "Material-to-assignment flow",
  "home.helps.resources_body": "Teachers can assign existing ArcMath content or selected pages and problem ranges from uploaded PDFs, including long textbooks.",
  "home.helps.guided_title": "Teacher preparation",
  "home.helps.guided_body": "Preview chapters and analyze hard problems with concise key ideas for teachers, separated from student-facing answer generation.",
  "home.helps.reports_title": "Gradebook and reports",
  "home.helps.reports_body": "Teachers see completion, submissions, scores, feedback, hint usage, and verified grading traces in one place.",
  "home.quickstart.badge_member": "Ready to continue",
  "home.quickstart.badge_guest": "School workspace",
  "home.quickstart.title_member": "Jump back into your workflow.",
  "home.quickstart.title_guest": "Set up a school or tutoring org.",
  "home.quickstart.body_member": "Your main tools are ready to open whenever you want to continue.",
  "home.quickstart.body_guest": "Create the admin account first. After verification, use the org dashboard to create classes, assign teachers, add students, publish materials, and review submissions.",
  ...
  "home.quickstart.link_create": "Create School Account",
...
export const ZH: Messages = {
  ...
  "for_schools.eyebrow": "面向学校与教培机构",
  "for_schools.hero_title": "服务数学课堂的教学辅助平台。",
  "for_schools.hero_lede": "Arcmath 把班级管理、PDF 教材、作业布置、学生提交、可信批改和教师端分析放进同一套流程，适合国际学校和数学教培机构内部使用。",
  "for_schools.cta_email": "联系我们",
  "for_schools.cta_register_school": "创建学校账号",
  "for_schools.why_eyebrow": "为什么这件事值得做",
  "for_schools.why_title": "数学教学需要的不只是题库。",
  "for_schools.why_body_1": "学校需要一个统一位置来管理班级、布置合适的材料、在截止时间前收齐作业，并看清学生到底是怎样推理和犯错的。",
  "for_schools.why_body_2": "Arcmath 围绕这套日常教学流程设计：管理员管理机构，老师备课和批改，学生获得结构化反馈，但系统不会直接把答案倒给学生。",
  "for_schools.why_callout_label": "产品重点",
  "for_schools.why_callout_body": "平台优先服务学校内部教学：名册、班级、PDF 材料、指定页码与题号的作业、提交、批改、报告和教师备课辅助。",
  "for_schools.pillars_eyebrow": "Arcmath 是什么",
  "for_schools.pillars_title": "三个产品层协同工作。",
  "for_schools.pillar_1_title": "机构管理",
  "for_schools.pillar_1_body": "每个机构都有管理员账号，可以创建班级、分配老师和学生，并查看机构内账号的学习与作业信息。",
  "for_schools.pillar_2_title": "基于材料的作业",
  "for_schools.pillar_2_body": "老师可以上传 PDF，选择指定页码或题号区间，也可以结合 Arcmath 现有资源，设置截止时间并统一收集学生提交。",
  "for_schools.pillar_3_title": "可信批改与学情洞察",
  "for_schools.pillar_3_body": "学生答案可结合形式化验证意识的批改信号、教师复核、班级成绩册和报告一起查看，让薄弱点变得清楚，同时保留原始作答过程。",
  "for_schools.core_eyebrow": "核心功能",
  "for_schools.core_title": "页面应该展示老师和学生真正会做的事。",
  "for_schools.core_lede": "这些动态模块展示完整学习闭环：采集数学输入、检查推理、给出教师安全的提示，并把提交结果转化成班级层面的洞察。",
  "for_schools.flow_eyebrow": "学校工作流",
  "for_schools.flow_title": "从班级配置到完成批改。",
  "for_schools.flow_1_title": "配置机构。",
  "for_schools.flow_1_body": "机构管理员创建班级，邀请或创建教师账号，并把学生账号放进对应班级。",
  "for_schools.flow_2_title": "准备作业。",
  "for_schools.flow_2_body": "老师上传 PDF 或使用平台资源，选择具体页码和题号范围，把选中的题目转成作业项，并设置截止时间。",
  "for_schools.flow_3_title": "学生提交。",
  "for_schools.flow_3_body": "学生打开已布置的材料，书写或上传答案，并在截止时间前提交。迟交和未交状态会保留给老师查看。",
  "for_schools.flow_4_title": "教师批改与复盘。",
  "for_schools.flow_4_body": "教师借助可信批改信号完成评分，然后查看班级结果和单个学生的历史记录。",
  "for_schools.contact_eyebrow": "下一步",
  "for_schools.cta_panel_title": "讨论学校部署",
  ...
  "legal.terms_body_who": "Arcmath 是数学教学与练习平台。年满 13 周岁可自行注册个人账号。未满 13 周岁的学生须由学校在机构协议下接入，并由家长/法定监护人在学生开始练习前给予同意。",
  ...
  "legal.terms_body_disclaimer": "当前预生产阶段 Arcmath 按现状提供，不保证具体成绩、竞赛名次或申请结果。法律允许范围内 Arcmath 不对使用平台产生的间接或衍生损失负责。",
  "legal.terms_h_changes": "条款变更",
  "legal.terms_body_changes": "如发生实质性变更，至少提前 14 天用邮箱通知已注册用户。",
  ...
  "register.subtitle": "注册一个 Arcmath 个人账号，使用题库、逐步批改和个人学习报告。",
  ...
  "org.overview.action.resource.assignment.draft": "{actor} 格式化了一份 PDF 作业草稿",
  "org.overview.action.resource.assignment.extract": "{actor} 提取了 PDF 指定页文本",
  "org.overview.action.class.invite_students": "{actor} 向班级邀请了学生",
  "org.overview.action.teacher.invite": "{actor} 邀请了一位老师",
  "org.overview.action.teacher.prep.generate": "{actor} 生成了一份教师备课简报",
  ...
  "home.hero.kicker": "面向学校、培训机构与数学教研组",
  "home.hero.headline": "教学平台，覆盖班级作业与可信批改。",
  "home.hero.subhead": "管理班级，用 PDF 或题库布置作业，收取学生提交，并在适用题型中接入形式化验证批改。",
  "home.hero.pill_practice": "组织名册与班级管理",
  "home.hero.pill_progress": "PDF 转作业流程",
  "home.hero.pill_aesthetic": "可信批改 · 报告 · 备课助手",
  ...
  "home.hero.cta_student": "个人练习入口",
  "home.hero.cta_school": "创建学校账号",
  "home.hero.student_label": "个人学习者",
  "home.hero.student_tagline": "继续使用 ArcMath 题库、逐步反馈、提示、OCR 和个人学习报告。",
  "home.hero.school_label": "学校与培训机构",
  "home.hero.school_tagline": "一个 admin 账号管理整个组织，创建班级、指派老师和学生，并查看组织内账号活动。",
  "home.hero.signin_prompt": "已有账号？",
  "home.hero.signin_link": "登录",
  "home.stats.practice_label": "组织管理",
  "home.stats.practice_value": "1 个 admin",
  "home.stats.practice_desc": "每个组织由一个 admin 账号拥有：创建班级、指派老师和学生、重置密码、查看组织内活动。",
  "home.stats.verification_label": "作业来源",
  "home.stats.verification_value": "PDF + 题库",
  "home.stats.verification_desc": "老师可以使用 ArcMath 题库，也可以从自己的 PDF 材料中选择页码和题号范围，设置截止时间后发布。",
  "home.stats.library_label": "批改",
  "home.stats.library_value": "可信验证",
  "home.stats.library_desc": "结构化题目尽可能使用符号化和形式化验证后端；PDF 手工作业保留老师复核与清晰评分记录。",
  "home.platform.eyebrow": "学校工作流",
  "home.platform.title": "核心课堂流程已经围绕角色重新组织。",
  "home.platform.lede": "ArcMath 不只是竞赛题库，而是数学课堂的运行层：班级、作业、资源、提交、批改与进度可见性集中在一个平台。",
  "home.platform.admin_title": "Admin 管理组织",
  "home.platform.admin_meta": "创建班级 · 指派账号",
  "home.platform.admin_body": "学校或机构获得一个 admin 账号。Admin 创建班级、添加老师与学生、控制成员关系，并可查看组织内任意账号信息。",
  "home.platform.material_title": "老师从材料布置作业",
  "home.platform.material_meta": "PDF 页码 · 题号范围 · 题库",
  "home.platform.material_body": "老师上传 PDF，从长教材中选择指定页和题号，把原始材料转换为适合作业的格式，也可以直接布置 ArcMath 题集。",
  "home.platform.student_title": "学生按截止时间提交",
  "home.platform.student_meta": "结构化作答 · 附件提交",
  "home.platform.student_body": "学生在自己的班级作业列表中看到任务；结构化题目进入数学工作台，PDF/手工作业可上传书面解答。",
  "home.platform.gradebook_title": "老师批改与复盘",
  ...
  "home.demo.ocr_eyebrow": "01 / 学生输入",
  "home.demo.ocr_title": "手写拍照转 LaTeX，核对后提交。",
  "home.demo.grading_eyebrow": "02 / 可信批改",
  "home.demo.grading_title": "清楚看到每一步由哪个引擎签名。",
  "home.demo.hint_eyebrow": "03 / 教师安全辅助",
  "home.demo.hint_title": "提供简洁提示与备课支持，不直接倾倒答案。",
  "home.demo.report_eyebrow": "04 / 班级洞察",
  "home.demo.report_title": "老师能据此行动的进度数据。",
  "home.hero.florid_word": "数学",
  "home.cards.sympy_title": "01 / SymPy",
  "home.cards.sympy_body": "代数恒等、方程化简、简单不等式。对可结构化的步骤，SymPy 可直接给出确定性判断，无需 LLM 往返。",
  "home.cards.lean_title": "02 / Lean kernel",
  "home.cards.lean_body": "证明级命题可进入 Lean 与 mathlib。只要 type-check 通过，结论来自 kernel，而不是自然语言置信度。",
  "home.cards.llm_title": "03 / LLM judge",
  "home.cards.llm_body": "形式化暂未覆盖的论证，可由 LLM judge 摘要或标记推理风险，并明确标注来源，不混进黑盒分数。",
  "home.helps.kicker": "为数学教研团队而建",
  "home.helps.headline": "Canvas 风格的班级运营，叠加数学专用智能。",
  "home.helps.subhead": "平台覆盖学校真实需要的内部流程：名册、材料、截止时间、提交、批改、报告和备课。",
  "home.helps.assignments_title": "班级与名册控制",
  "home.helps.assignments_body": "Admin 创建班级、指派老师和学生账号，从一个位置管理整个组织。",
  "home.helps.resources_title": "材料转作业",
  "home.helps.resources_body": "老师可布置 ArcMath 题库，也可从上传 PDF 中选择页码和题号范围，包括长教材。",
  "home.helps.guided_title": "教师备课辅助",
  "home.helps.guided_body": "用简洁语言预览章节和分析难题关键思路，与面向学生的答案生成严格区分。",
  "home.helps.reports_title": "Gradebook 与报告",
  "home.helps.reports_body": "老师查看完成情况、提交、分数、反馈、提示使用和可信批改轨迹。",
  "home.quickstart.badge_member": "继续学习",
  "home.quickstart.badge_guest": "学校工作区",
  "home.quickstart.title_member": "回到你的学习流程。",
  "home.quickstart.title_guest": "开通学校或培训机构。",
  "home.quickstart.body_member": "主要功能就在手边，随时打开继续。",
  "home.quickstart.body_guest": "先创建 admin 账号。完成邮箱验证后，在组织控制台创建班级、指派老师、添加学生、发布材料并查看提交。",
  ...
  "home.quickstart.link_create": "创建学校账号",
